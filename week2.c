...
int main( void )
{
	...
	while( cont == YES )
	{
		...
		clear_kb();fflush(stdout); /* remove extra characters from keyboard buffer */
 ...
 * continue to get data until either 100 people are *
 * entered, or the user choose not to continue. *
 * Returns: nothing *
 ...
 * Purpose: This function displays a report to the scteen *
 * Returns: nothing *
 ...
 * Return: YES - if user wishes to continue *
 ...
 * Returns: Nothing *
 * Note: Thos function could be replaced by fflush(stdin); *
 *----------------------------------------------------------*/
void clear_kb(void)
{
	char junk[80];
